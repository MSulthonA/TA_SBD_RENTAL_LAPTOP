...
<head>
  ...
  <title>TA sbd | Rental Laptop Barokah</title>
...
<div class="wrapper">
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="index3.html" class="brand-link">
      ...
      <span class="brand-text font-weight-light">Rental Laptop Barokah</span>
    </a>
        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item menu-open">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="./tabel/administrator" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Admin</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="./tabel/peminjam" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Peminjam</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="./tabel/laptop" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Laptop</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="./tabel/peminjaman" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Peminjaman</p>
                </a>
              </li>
